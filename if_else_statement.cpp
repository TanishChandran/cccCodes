// Control statement allows you to control the flow of your code and allows your program to make decisions at the time of execution. One such statement is the if-else statement.
